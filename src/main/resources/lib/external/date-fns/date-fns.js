/**
 * version used: https://cdnjs.cloudflare.com/ajax/libs/date-fns/1.30.1/date_fns.js
 */
...
/***/ function (module, exports, __webpack_require__) {
			...
			function buildFormatLocale () {
				...
				ordinalFormatters.forEach(function (formatterToken) {
					formatters[formatterToken + 'o'] = function (date, formatterList) {
						return ordinal(formatterList[formatterToken](date));
					};
				});
				return {
